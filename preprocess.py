...
if __name__ == '__main__':
    ...
    train_texts.extend(train_texts2)
    train_labels.extend(train_labels2)

    train_data3 = pd.read_csv('data/trac2_eng_train.csv', encoding='utf8')
    train_texts3 = train_data3.Text.tolist()
    train_labels3 = train_data3["Sub-task B"].tolist()
    t_dict = {'GEN':'sexist', 'NGEN':'not sexist'}
    train_labels3 = [t_dict[label] for label in train_labels3]
    train_texts.extend(train_texts3)
    train_labels.extend(train_labels3)

    train_data3 = pd.read_csv('data/trac2_eng_dev.csv', encoding='utf8')
    train_texts3 = train_data3.Text.tolist()
    train_labels3 = train_data3["Sub-task B"].tolist()
    train_labels3 = [t_dict[label] for label in train_labels3]
    train_texts.extend(train_texts3)
